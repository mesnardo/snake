# file: getNumberCellsVisIt.py
# author: Olivier Mesnard (mesnardo@gwu.edu)
# description: Calls VisIt in batch mode to grab the number of cells 
#              at each requested state and computes mean.
...
def parse_command_line():
  ...
  parser.add_argument('--time-limits', dest='time_limits', 
                      type=float, nargs=2, 
